...
class Elem {
	...
	addChildTop(child) {
		this.elem.insertBefore(child.elem, this.elem.firstChild)
	}
...
var oldTwemojiParse = twemoji.parse

twemoji.parse = (...args) => {
	var res = oldTwemojiParse(...args)
	return res.replaceAll("https://twemoji.maxcdn.com/v/14.0.2/", "https://cdnjs.cloudflare.com/ajax/libs/twemoji/14.0.2/")
}